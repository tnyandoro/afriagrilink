      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-gradient-to-br from-[#FFA726] to-[#4CAF50] rounded-full flex items-center justify-center">
              <span className="text-white font-bold text-lg">AL</span>
            </div>
            <span className="text-xl font-bold">AfriAgriLink</span>
          </div>

          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-8">
            <a href="#about" className="hover:text-[#FFA726] transition-colors">About</a>
            <a href="#how-it-works" className="hover:text-[#FFA726] transition-colors">How It Works</a>
            <a href="#marketplace" className="hover:text-[#FFA726] transition-colors">Marketplace</a>
            <a href="#contact" className="hover:text-[#FFA726] transition-colors">Contact</a>
